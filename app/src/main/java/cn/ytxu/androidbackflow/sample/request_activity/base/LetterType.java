package cn.ytxu.androidbackflow.sample.request_activity.base;
...
public enum LetterType {
    ...
    LetterType() {
        this.atyName = String.format("cn.ytxu.androidbackflow.sample.request_activity.letter.Letter%sActivity", name().toUpperCase());
    }
