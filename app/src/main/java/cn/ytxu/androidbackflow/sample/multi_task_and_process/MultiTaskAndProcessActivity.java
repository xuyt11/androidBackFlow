package cn.ytxu.androidbackflow.sample.multi_task_and_process;
 ...
 */
public class MultiTaskAndProcessActivity extends BaseActivity implements View.OnClickListener {
    private static final String TAG = MultiTaskAndProcessActivity.class.getSimpleName();
...
//                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            ...
            case R.id.main_btn_4_multi: {
                startActivity(new Intent(this, MultiTaskAndProcessActivity.class));
            }
            default:
                break;
        }
